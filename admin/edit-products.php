...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Compania del producto Name" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio con descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Descuento" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Precio normal</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Precio" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Descripcion" rows="6" class="span8 tip">
...
<div class="control-group">
<label class="control-label" for="basicinput">Cargo de envio</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="cargo de envio" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">En existencias</label>
<div class="controls">
