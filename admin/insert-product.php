...
<div class="control-group">
<label class="control-label" for="basicinput">Sub Categorias</label>
<div class="controls">
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Compania del producto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto antes del descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Precio con descuento" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Precio normal" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Cargo de envio" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Existencias del producto</label>
<div class="controls">
<select   name="productAvailability"  id="productAvailability" class="span8 tip" required>
<option value="">Select</option>
<option value="In Stock">En exitencia</option>
<option value="Out of Stock">No quedan existencias</option>
</select>
</div>
</div>
