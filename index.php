...
<html lang="en">
	<head>
	    ...
	    <title href="index.php">Talaveras - "El alfa" Pagina de inicio</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Politica de devolucion</h4>
						</div>
					</div>	
					<h6 class="text">Despues de 30 dias ya no se devolvera el producto</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">El envio sera gratis apartir de los 500$</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Por temporada descuento del 20% </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				...
				<?php if($row['productAvailability']=='ock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Agregar al carrito</a></div>
				<?php } else {?>
						<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
